...
export default function GlobalHeader() {
  ...
  const formattedExpiry = rawExpiry 
    ? new Date(rawExpiry).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: '2-digit' })
    : 'N/A';
      ...
      <View className="flex-row justify-between items-start mt-2">
        ...
        <View className="flex-1 pr-4 justify-center">
          ...
          <View className="flex-row items-center pr-2">
            {isOwner ? (
              <Feather name="map-pin" size={12} color="#bfb5a8" className="mr-1" />
            ) : (
